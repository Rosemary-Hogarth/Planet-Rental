...
class PlanetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create planet" do
    assert_difference("Planet.count") do
      post planets_url, params: { planet: { description: @planet.description, glaxy: @planet.glaxy, name: @planet.name, price_per_night: @planet.price_per_night, system: @planet.system } }
    end
  ...
  test "should update planet" do
    patch planet_url(@planet), params: { planet: { description: @planet.description, glaxy: @planet.glaxy, name: @planet.name, price_per_night: @planet.price_per_night, system: @planet.system } }
